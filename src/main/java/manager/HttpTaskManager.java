...
public class HttpTaskManager extends FileBackedTasksManager {
    ...
    public void load() {
        ...
        var prioritizedTaskType = new TypeToken<Set<Task>>() {
        }.getType();
        ...
        var subtaskType = new TypeToken<Map<Integer, Subtask>>() {
        }.getType();
